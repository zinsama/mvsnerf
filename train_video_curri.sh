CUDA_VISIBLE_DEVICES=2  python train_videodata.py  \
    --dataset_name MyDataset --datadir ./video_data/pic/beef_curri2/9 \
    --expname train_video_beef_curri6  --with_rgb_loss  --batch_size 2048  \
...
CUDA_VISIBLE_DEVICES=2  python train_videodata.py  \
    ...
    --num_epochs 3 --imgScale_test 1.0 --white_bkgd  --pad 0 \
    --N_vis 1 \
    --model_ckpt ./runs_fine_tuning/train_video_beef_curri6/ckpts
CUDA_VISIBLE_DEVICES=2  python train_videodata.py  \
